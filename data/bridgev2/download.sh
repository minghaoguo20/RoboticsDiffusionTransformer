...
python bridgedata_raw_to_numpy.py --input_path ../datasets/bridgev2/raw/raw --output_path ../datasets/bridgev2/npy
# Convert the dataset to tfrecords
python bridgedata_numpy_to_tfrecord.py --input_path ../datasets/bridgev2/npy --output_path ../datasets/bridgev2/tfrecords
